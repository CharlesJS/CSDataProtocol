...
// https://github.com/apple/swift-corelibs-foundation/blob/main/Sources/Foundation/ContiguousBytes.swift
...
extension Slice : ContiguousBytes where Base : ContiguousBytes {
    public func withUnsafeBytes<ResultType>(_ body: (UnsafeRawBufferPointer) throws -> ResultType) rethrows -> ResultType {
        try self._withUnsafeBytes(body)
    }

    public func _withUnsafeBytes<ResultType>(_ body: (UnsafeRawBufferPointer) throws -> ResultType) rethrows -> ResultType {
